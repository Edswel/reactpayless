      ...
      <div className={
        ...
        <header>
          <Navbar className='navbar-background' variant="dark" expand="lg">
            <Container>
              <Button className='mx-1' variant='light' onClick={() => setSidebarIsOpen(!sidebarIsOpen)}>
                <i className='fas fa-bars'></i>
              </Button>
              <LinkContainer to="/">
                <Navbar.Brand>PayLess</Navbar.Brand>
              </LinkContainer>
        ...
        <footer className='footer-background'>
          <div className='text-center'>© {new Date().getFullYear()} PayLess. All rights reserved.</div>
        </footer>
      </div>
    </BrowserRouter>
  );
